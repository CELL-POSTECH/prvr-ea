...
DATASET_DEFAULTS = {
    "tvr": {
        ...
        "frame_source": "frames",
        "sampled_frame_root": str(DATA_ROOT / "tvr/verification_frames"),
    ...
    "activitynet": {
        ...
        "frame_source": "paths",
        "sampled_frame_root": str(DATA_ROOT / "activitynet/verification_frames"),
        "sampled_frame_layout": "video_time",
    ...
    "charades": {
        ...
        "frame_source": "paths",
        "sampled_frame_root": str(DATA_ROOT / "charades/verification_frames"),
        "sampled_frame_layout": "video_time",
        "pseudo_window_mode": "gt_clamped",
        "pseudo_window_sec": 4.0,
        "pseudo_window_min_sec": 4.0,
    ...
    "msrvtt": {
        ...
        "frame_source": "paths",
        "sampled_frame_root": str(DATA_ROOT / "msrvtt/verification_frames"),
        "sampled_frame_layout": "video_time",
        "pseudo_window_mode": "fixed",
        "pseudo_window_sec": 4.0,
        "pseudo_window_min_sec": 4.0,
