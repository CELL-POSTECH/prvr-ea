...
plot_dir=VIS/qvhighlights_val

prvr_train_annos=annotations/qvhighlights_train.jsonl
prvr_val_annos=annotations/qvhighlights_val.jsonl
...
do_train=0
do_eval=1
resume=logs/prvr_qvhighlights_val/ckpt.best.pth.tar
...
model_dir="logs/prvr_qvhighlights_val"
