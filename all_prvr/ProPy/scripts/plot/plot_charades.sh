...
video_dir=/home/panyi/Charades_dataset/compressed_videos
pretrained_dir=CLIP_weights
plot_dir=VIS/charades

prvr_train_annos=annotations/charades_train.jsonl
prvr_val_annos=annotations/charades_val.jsonl
...
do_train=0
do_eval=1
resume=logs/prvr_charades/ckpt.best.pth.tar
