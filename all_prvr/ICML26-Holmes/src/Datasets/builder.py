...
def get_datasets(cfg):
    ...
    visual_feats = os.path.join(rootpath, collection, 'FeatureData',
        'new_clip_vit_32_%s_vid_features.hdf5' % collection) if cfg['feature_mode'] == 'clip' else visual_feat_path
    ...
    test_visual_feats = os.path.join(rootpath, collection, 'FeatureData',
        'new_clip_vit_32_%s_vid_features.hdf5' % collection) if cfg['feature_mode'] == 'clip' else test_visual_feat_path
