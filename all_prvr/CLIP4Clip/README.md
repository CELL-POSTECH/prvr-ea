...
## PRVR raw-frame datasets

For MSRVTT, ActivityNet, TVR, and Charades adapters that read the PRVR
decoded-frame directories, see [PRVR_RAWFRAMES.md](PRVR_RAWFRAMES.md).
