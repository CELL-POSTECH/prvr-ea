...
def start_training(opt):
    ...
    # DL-DKD is a dual-feature method: the student always receives the
    # original ResNet/I3D visual and RoBERTa/BERT text features, while the
    # CLIP-B/32 features below are the distillation teacher.  `resnet` here
    # selects the student-text format, including MSRVTT's supplied BERT HDF5.
    text_feat_path = {'train': text_feature_path(rootpath, collection, 'resnet'),
                      'val': text_feature_path(rootpath, collection, 'resnet')}
