...
def get_configs(dataset_name):
    ...
    cfg = configure_cfg(config.get_cfg_defaults(), dataset_name,
                        os.path.abspath(os.path.join(os.path.dirname(__file__), '../..')))
    cfg['use_clip_feat'] = cfg['feature_mode'] == 'clip'
    cfg['collection_val'] = cfg['collection']
    cfg['sval_root'] = os.path.join(os.path.dirname(__file__), '..', 'Sval', 'data')
    return cfg
